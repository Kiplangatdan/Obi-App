...
var ThanksPage = (function () {
    ...
    ThanksPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-thank-you',template:/*ion-inline-start:"/home/danco/Ionic/Obi_app/src/pages/thank-you/thank-you.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Thank You!</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n	<div *ngIf="order">\n		<h2>Thank you for your order!</h2>\n\n		<ion-list>\n\n			<ion-item *ngFor="let item of order.line_items">\n				<p>{{item.name}}</p>\n				<p>{{item.total}}</p>\n			</ion-item>\n			<ion-item><strong>Total: {{order.total}}</strong></ion-item>\n			<ion-item><p>Status: {{order.status}}</p></ion-item>\n		</ion-list>\n\n	</div>\n\n</ion-content>\n'/*ion-inline-end:"/home/danco/Ionic/Obi_app/src/pages/thank-you/thank-you.html"*/,
        }),
